...
| `ls-rule-gate-acceptance` | Rule | `.agents/rules/ls-rule-gate-acceptance.md` | Brain | Active | Phase 1 technical gate pass/fail rule for Satellite delivery. | PR or delivery request. | Gate-ready delivery decision based on tests, integrity, package contract, and logs. | Required before all Phase 1 delivery. | `ls-workflow-gitpush` |
