...
1. **Hiến pháp Tối thượng:** Tuyệt đối tuân thủ `.LinkStrategy/04_SOP_LINK_STRATEGY.md` (Quy tắc vận hành) và `.LinkStrategy/05_FULL_SYSTEM_CONFIGURATION.md` (Cấu trúc hệ thống).
