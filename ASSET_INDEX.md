...
| `ls-rule-gate-acceptance` | Rule | `.agents/rules/ls-rule-gate-acceptance.md` | Brain | Active | Phase 1 technical gate pass/fail rule for Satellite delivery. | Direct-main delivery request. | Gate-ready delivery decision based on tests, integrity, package contract, logs, and CI status before Brain harvest. | Required before all Phase 1 delivery. | `ls-workflow-gitpush` |
